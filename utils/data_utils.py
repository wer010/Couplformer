...
def get_loader(args):
    ...
    if args.dataset == "cifar10":
        ...
        trainset = datasets.ImageFolder(root="/home/huangyanhui/caltech256/train/",  transform=transform_train)
        testset = datasets.ImageFolder(root="/home/huangyanhui/caltech256/test/",                      transform=transform_test) if args.local_rank in [-1, 0] else None
    else:
